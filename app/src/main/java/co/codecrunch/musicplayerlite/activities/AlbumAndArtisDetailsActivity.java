...
import co.codecrunch.musicplayerlite.observablelib.ObservableScrollView;
import co.codecrunch.musicplayerlite.observablelib.ObservableScrollViewCallbacks;
import co.codecrunch.musicplayerlite.observablelib.ScrollState;
import co.codecrunch.musicplayerlite.observablelib.ScrollUtils;
...
import co.codecrunch.musicplayerlite.uicomponent.ExpandableHeightListView;
...
public class AlbumAndArtisDetailsActivity extends ActionBarActivity implements View.OnClickListener, ObservableScrollViewCallbacks, Slider.OnValueChangedListener,
    ...
    public void theme() {
        ...
        MusicPlayerUtility.settingTheme(context, 0);
    }
