...
import co.codecrunch.musicplayerlite.ApplicationMusicPlayer;
import co.codecrunch.musicplayerlite.dbhandler.FavoritePlayTableHelper;
import co.codecrunch.musicplayerlite.dbhandler.MostAndRecentPlayTableHelper;
...
public class MediaController implements NotificationManager.NotificationCenterDelegate, SensorEventListener {
    ...
    public boolean playAudio(SongDetail mSongDetail) {
        ...
        if (MusicPreferance.playingSongDetail != null) {
            Intent intent = new Intent(ApplicationMusicPlayer.applicationContext, MusicPlayerService.class);
            ApplicationMusicPlayer.applicationContext.startService(intent);
        } else {
            Intent intent = new Intent(ApplicationMusicPlayer.applicationContext, MusicPlayerService.class);
            ApplicationMusicPlayer.applicationContext.stopService(intent);
        }

        storeResendPlay(ApplicationMusicPlayer.applicationContext, mSongDetail);
