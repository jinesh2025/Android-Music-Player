 ...
 */
package co.codecrunch.musicplayerlite.phonemidea;
...
//                sortOrder = MediaStore.Audio.Media.DATE_ADDED + " desc";
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        if (delay == 0) {
            ApplicationMusicPlayer.applicationHandler.post(runnable);
        } else {
            ApplicationMusicPlayer.applicationHandler.postDelayed(runnable, delay);
        }
    }
